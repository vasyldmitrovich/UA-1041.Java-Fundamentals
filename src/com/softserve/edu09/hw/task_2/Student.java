...
public class Student {
    ...
    public Student(String name, int group, int course, double mathGrade, double englishGrade, double physicGrade) {
        this.name = name;
        this.group = group;
        this.course = course;
        this.grades.put("math", mathGrade);
        this.grades.put("english", englishGrade);
        this.grades.put("physic", physicGrade);
    }
